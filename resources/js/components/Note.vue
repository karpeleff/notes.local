...
<div>
  <div class="overflow-x-auto">
      <spin v-if="loading"></spin>
        <div  v-else class="min-w-screen min-h-screen bg-gray-100 flex items-center justify-center bg-gray-100 font-sans overflow-hidden">
                ...
                <div class="bg-white shadow-md rounded my-6">
                    ...
                    <table   class="min-w-max w-full table-auto">
                        ...
                        <tbody class="text-gray-600 text-sm font-light">
                            <tr class="border-b border-gray-200 hover:bg-gray-100" v-for="page in pages">
...
export default {
    ...
    methods: {
        getPages() {
            axios.get("note")
                .then((response) => { this.pages = response.data.notes; });
            this.loading = false;
        },
        sendForm() {
        },
